        ...
        <div className = 'footer mt-5 text-white'>
           <div className = 'row pt-5 px-5 mb-4'>
               <div className = 'col-md-3 col-lg-3'>
                   ...
                   <Link to = '/contact' style = {{textDecoration: 'none'}}>Help Center</Link> <br/><br/>
                   <Link to = '/about' style = {{textDecoration: 'none'}}>Location</Link> <br/><br/>
                   <Link to = '/about' style = {{textDecoration: 'none'}}>About Us</Link> <br/><br/>
               ...
               <div className = 'col-md-3 col-lg-3 '>
                   ...
                   <Link to = '/about' style = {{textDecoration: 'none'}}>Sitemap</Link> <br/><br/>
                   <Link to = '/about' style = {{textDecoration: 'none'}}>Privacy</Link> <br/><br/>
                   <Link to = '/contact' style = {{textDecoration: 'none'}}>Help</Link> <br/><br/>
                   </div>
               ...
               <div className = 'col-md-3 col-lg-3'>
                   ...
                   <div style = {{width: '130px', borderTop: '2px solid white'}}><br/>
                   <Link to = '/about' style = {{textDecoration: 'none'}}>Terms Of Service</Link> <br/><br/>
                   <Link to = '/about' style = {{textDecoration: 'none'}}>Registry</Link> <br/><br/>
                   <Link to = '/about' style = {{textDecoration: 'none'}}>Standard</Link> <br/><br/>
                   </div>
