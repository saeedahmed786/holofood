        ...
        return ( 
             ...
             <div className = 'container text-center signin-form pt-4 pb-4'>
                <form onSubmit = {submitHandler}>
                    ...
                    <input type = 'radio' className = 'text-center' id = 'paymentMethod' value = 'Paypal' name ='paymentMethod' required onChange = { (e) => setPaymentMethod(e.target.value)}></input><br/><br/>
